 ...
 * (actual y del próximo nivel), requisitos para subir de nivel,
 * capacidad de bodega (tope de oro almacenables), y estado de
 * reparación (si puede pelear y cuánto costaría reparar a 100%).
 */
